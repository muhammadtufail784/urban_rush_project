...
const ThirdSeciton = () => {
  return (
    <section className="py-24 bg-gradient-to-br from-[#EAF7FE] via-white to-[#E9FAEB] bg-no-repeat"
 style={{
...
>
  ...
  <div className="flex flex-col md:flex-row items-center justify-center gap-8">
    <StepCard
      ...
      imgClassName=" bottom-0 md:left-[22px] left-[1px] h-[300px]"
    />
    <StepCard
      stepNumber="2"
      ...
      imgSrc="/map.png"
      imgClassName=" bottom-0 left-1/2 -translate-x-1/2 h-[280px] w-[273px]"
    />
    <StepCard
      stepNumber="3"
